...
# Updated and linted for Python 3 by ahebrank, 2019/01
...
class html2canvasproxy:
    ...
    def __init__(self, callback, url):
        ...
        elif not html2canvasproxy.is_http_url(url):
    ...
    def download_source(self):
        ...
        if self.ref != '':
            o = urllib.parse.urlparse(self.ref)
    ...
    def save_file(self):
        file_name = hashlib.sha1(self.url.encode('utf-8')).hexdigest()
    ...
    def hostname(self, url):
        ...
        if not html2canvasproxy.is_http_url(url):
