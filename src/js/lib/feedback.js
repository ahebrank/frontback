...
(function($){
	...
	var settings = $.extend({
			...
			tpl: {
				...
				overview:		'<div class="ftbk-feedback" id="feedback-overview"><div class="feedback-logo">Feedback</div><div id="feedback-overview-description"><div id="feedback-email-text"><h3>Username / Email</h3><input type="text" name="feedback-email" id="feedback-email"></div><div id="feedback-overview-title-text"><h3>Issue title</h3><input type="text" name="feedback-overview-title" id="feedback-overview-title"></div><div id="feedback-overview-description-text"><h3>Description</h3><h3 class="feedback-additional">Additional info</h3><div id="feedback-additional-none"><span>None</span></div><div id="feedback-browser-info"><span>Browser Info</span></div><div id="feedback-page-info"><span>URL</span></div><div id="feedback-page-structure"><span>Markup</span></div></div></div><div id="feedback-overview-screenshot"><h3>Screenshot</h3></div><div class="feedback-buttons"><button id="feedback-submit" class="feedback-submit-btn feedback-btn-blue">Submit</button><button id="feedback-overview-back" class="feedback-back-btn feedback-btn-gray">Back</button></div><div id="feedback-overview-error">Please enter an email and a title/description.</div><div class="feedback-wizard-close"></div></div>',
