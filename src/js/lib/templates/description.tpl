<div class="ftbk-feedback" id="ftbk-feedback-welcome">
	...
	<button id="ftbk-feedback-welcome-next" class="ftbk-feedback-next-btn feedback-btn-gray">Next</button>

	<div id="ftbk-feedback-welcome-error">Please enter a description.</div><div class="ftbk-feedback-wizard-close"></div>
</div>